 ...
 *
 *
 * This template is designed to work with bootstrap5 and bootstrap icons (https://icons.getbootstrap.com/).
 *
 */
...
<div class="jim-toolbox toolbox-close">
    <div class="toolbox-toggle">
        ...
        <div class="toolbox-toggle-top d-flex flex-column justify-content-center align-items-center mb-1">
            <i class="bi bi-plus-square text-toggle-plus"></i>
            <i class="bi bi-dash-square text-toggle-minus"></i>
            <i class="bi bi-arrow-up-circle mt-3 arrow-icon arrow-icon-up"></i>
        </div>
        ...
        <div class="d-flex justify-content-center mt-1">
            <i class="bi bi-arrow-down-circle arrow-icon arrow-icon-down"></i>
        </div>
    </div>
        ...
        <div class="toolbox-content">
            ...
            <div class="toolbox-module" data-id="_acp">
                <div class="toolbox-title">
                    <button type="button" class="btn-close close float-end toolbox-close-btn" aria-label="Close">
                    </button>
