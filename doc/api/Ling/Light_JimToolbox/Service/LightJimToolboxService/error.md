...
Source Code
===========
See the source code for method [LightJimToolboxService::error](https://github.com/lingtalfi/Light_JimToolbox/blob/master/Service/LightJimToolboxService.php#L220-L223)
